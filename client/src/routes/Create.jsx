...
export function Create() {
  ...
  return <main className="grow">
          ...
          <div className="grid gap-2 border focus-within:border-ring focus-within:ring-3 focus-within:ring-ring/50 ">
            <Textarea value={text} className={"resize-none overflow-auto max-h-[36vh] border-0 focus-visible:ring-0"} maxLength={MAX_LENGTH} onChange={(e)=> {
          ...
          <Button disabled= {text.length > 0 ? false : true}>Post</Button>
        </div>
  </main>
}
