-- CreateEnum
CREATE TYPE "EventTypes" AS ENUM ('FOLLOW', 'POST', 'LIKE', 'COMMENT');
...
-- AddForeignKey
ALTER TABLE "followship" ADD CONSTRAINT "followship_followingId_fkey" FOREIGN KEY ("followingId") REFERENCES "user"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
