const { updateUser, deleteUser, searchUser, getCurrentUser, getUserInfo, followUser } = require("../controllers/userController")
...
userRouter.post("/:username/follow",followUser) // search user by query username
